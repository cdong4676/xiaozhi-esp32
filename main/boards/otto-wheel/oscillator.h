...
public:
    ...
    void SetSpeed(int speed);  // For continuous rotation servos (-100 to 100)
    void StopRotation();       // Stop continuous rotation
...
private:
    ...
    int rotation_speed_;  // Speed for continuous rotation (-100 to 100)
